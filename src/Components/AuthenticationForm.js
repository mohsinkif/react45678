...
export default function AuthenticationForm() {
    ...
    const loginHandler = () => {
        submit({email:formData.email, password:formData.password},{method:'post',action:'/userLogin',encType: "application/x-www-form-urlencoded",})
    }
                  ...
                  <form>
                    <div className="divide-y divide-gray-200">
                      <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                        ...
                        <div className="relative">
                          <button  className="bg-green-500 text-white rounded-md px-2 py-1" onClick={loginHandler}>Submit</button>
                        </div>
                      </div>
                    </div>
                  </form>
